...
-- Dumping structure for table apeck.email_recipients
CREATE TABLE IF NOT EXISTS `email_recipients` (
  `id` char(36) NOT NULL DEFAULT (uuid()),
  `email` varchar(255) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `type` enum('membership','general') NOT NULL DEFAULT 'membership',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `display_order` int NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `email_recipients_email_type_unique` (`email`,`type`),
  KEY `email_recipients_type_is_active_index` (`type`,`is_active`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
 

-- Dumping data for table apeck.email_recipients: ~2 rows (approximately)
INSERT INTO `email_recipients` (`id`, `email`, `name`, `type`, `is_active`, `display_order`, `created_at`, `updated_at`) VALUES
	('60d4926d-e2bf-4ce3-a3a6-cd7abf97d837', 'support@apeck.co.ke', 'Support', 'general', 1, 0, '2025-11-19 13:30:48', '2025-11-19 13:30:48'),
	('a501617d-ca2d-4535-b2c9-f20742da1d8a', 'membership@apeck.co.ke', 'Membership', 'membership', 1, 0, '2025-11-19 06:27:42', '2025-11-19 06:27:42'),
	('f68fed0d-7490-44d8-8449-18c46829fdd8', 'ceo@apeck.co.ke', 'CEO', 'membership', 1, 0, '2025-11-19 06:19:10', '2025-11-19 06:19:10');
...
-- Dumping data for table apeck.events: ~2 rows (approximately)
...
-- Dumping data for table apeck.knex_migrations: ~6 rows (approximately)
INSERT INTO `knex_migrations` (`id`, `name`, `batch`, `migration_time`) VALUES
	...
	(3, '202412010001_create_membership_applications.ts', 3, '2025-11-19 03:13:02'),
	(4, '202412010002_create_email_recipients.ts', 3, '2025-11-19 03:13:02'),
	(5, '202412010003_add_membership_application_fields.ts', 4, '2025-11-19 03:39:13'),
	(6, '202412010004_make_payment_reference_optional.ts', 5, '2025-11-19 03:46:13'),
	(7, '202412010005_add_corporate_membership_fields.ts', 6, '2025-11-19 05:47:58');
...
-- Dumping data for table apeck.knex_migrations_lock: ~0 rows (approximately)
...
INSERT INTO `media_assets` (`id`, `file_name`, `url`, `alt_text`, `mime_type`, `width`, `height`, `category`, `created_by`, `created_at`, `updated_at`) VALUES
	('09a478c6-b8ac-40e3-947d-d3e306450fb1', '1763562801092-75654984.mp4', '/uploads/1763562801092-75654984.mp4', NULL, 'video/mp4', NULL, NULL, 'video', NULL, '2025-11-19 14:33:23', '2025-11-19 14:33:23'),
...
-- Dumping structure for table apeck.membership_applications
CREATE TABLE IF NOT EXISTS `membership_applications` (
  ...
  `diaspora_country` varchar(100) DEFAULT NULL,
  `mpesa_code` varchar(100) DEFAULT NULL,
  `payment_reference` varchar(255) DEFAULT NULL,
  `payment_gateway` varchar(50) NOT NULL DEFAULT 'paystack',
  `amount_paid` decimal(10,2) NOT NULL,
  `membership_tier` varchar(100) NOT NULL DEFAULT 'Individual Member',
  ...
  `referral_apeck_number` varchar(100) DEFAULT NULL,
  ...
  `organization_kra_pin` varchar(255) DEFAULT NULL,
  ...
  `chairperson_id_number` varchar(255) DEFAULT NULL,
  `chairperson_kra_pin` varchar(255) DEFAULT NULL,
  `chairperson_phone` varchar(255) DEFAULT NULL,
  `chairperson_email` varchar(255) DEFAULT NULL,
  `secretary_name` varchar(255) DEFAULT NULL,
  `secretary_id_number` varchar(255) DEFAULT NULL,
  `secretary_kra_pin` varchar(255) DEFAULT NULL,
  `secretary_phone` varchar(255) DEFAULT NULL,
  `secretary_email` varchar(255) DEFAULT NULL,
  `treasurer_name` varchar(255) DEFAULT NULL,
  `treasurer_id_number` varchar(255) DEFAULT NULL,
  `treasurer_kra_pin` varchar(255) DEFAULT NULL,
  ...
  KEY `membership_applications_payment_reference_index` (`payment_reference`),
  KEY `membership_applications_status_index` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table apeck.membership_applications: ~1 rows (approximately)
INSERT INTO `membership_applications` (`id`, `full_name`, `phone`, `id_number`, `email`, `county`, `sub_county`, `ward`, `diaspora_country`, `mpesa_code`, `payment_reference`, `payment_gateway`, `amount_paid`, `membership_tier`, `status`, `notes`, `email_sent`, `email_sent_at`, `created_at`, `updated_at`, `church_name`, `title`, `title_other`, `referral_name`, `referral_apeck_number`, `referral_phone`, `signature`, `declaration_date`, `organization_name`, `organization_registration_number`, `organization_kra_pin`, `headquarters_location`, `organization_email`, `organization_phone`, `chairperson_name`, `chairperson_id_number`, `chairperson_kra_pin`, `chairperson_phone`, `chairperson_email`, `secretary_name`, `secretary_id_number`, `secretary_kra_pin`, `secretary_phone`, `secretary_email`, `treasurer_name`, `treasurer_id_number`, `treasurer_kra_pin`, `treasurer_phone`, `treasurer_email`) VALUES
	('09ea41ea-b054-4188-9de1-e61d0cf33914', 'Sostine Manyasi Waliaula', '0712061517', '234355235', 'sostinewaliaula@gmail.com', 'chwele', 'chwele', 'fdgd', 'Kenya', NULL, 'T615674055496441', 'paystack', 5.00, 'Individual Member', 'pending', NULL, 0, NULL, '2025-11-19 06:23:31', '2025-11-19 06:23:31', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	('1fa4c8f1-6d95-4e6b-8215-7545f2202ab1', 'Sostine Manyasi Waliaula', '0712061517', '43363', 'sostinewaliaula@gmail.com', 'Bomet', 'Bomet East', 'dsfds', NULL, NULL, 'T229229735735225', 'paystack', 5.00, 'Individual Member', 'pending', NULL, 0, NULL, '2025-11-19 13:16:20', '2025-11-19 13:16:20', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'sostinewaliaula@gmail.com', '0712061517', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- Dumping data for table apeck.news_posts: ~3 rows (approximately)
INSERT INTO `news_posts` (`id`, `slug`, `title`, `excerpt`, `body`, `status`, `published_at`, `hero_media_id`, `author_id`, `created_at`, `updated_at`, `hero_image_url`, `show_on_home`, `home_display_order`, `reading_time`) VALUES
	('20fb610f-5a8f-4bb7-be83-2672b50d5a90', 'apeck-s-mou-with-national-leadership', 'APECK\'s MOU with National Leadership', 'This iconic photo from May 5th, 2022, captures the moment over 1000 national delegates of APECK (Association of...', 'This iconic photo from May 5th, 2022, captures the moment over 1000 national delegates of APECK (Association of Pentecostal and Evangelical Clergy of Kenya) formalized a groundbreaking Memorandum of Understanding with the then-Deputy President, H.E. Dr. William Samoei Ruto, at the Karen Official Residence. More than a political alignment, this was a covenant focused on enshrining the fundamental rights of the Church. Key pillars of this agreement included securing freedom of worship, transitioning the Church from the limiting Societies Act to a new Religious Act, and establishing frameworks for religious self-regulation through church tribunals/mediation centers to handle Christian disputes internally. This move was crucial for protecting the integrity and autonomy of the faith community. 🤝 A Comprehensive Agenda for Church and Society The scope of this MOU was revolutionary, addressing both the governance of the Church and its role in national development. It secured commitments on practical matters such as ensuring Theological education is considered a professional field, creating provisions for clergy funds, and guaranteeing the right for evangelism by exempting preaching from the noise pollution category and recognizing it as a divine mandate in Kenya. Furthermore, it ensured that clergy would be considered for Government appointments and nominations, alongside securing the right to preach in Government stadia without payment. Legal witnesses to this landmark signing included prominent lawyers, Hon. Onesmas Kipchumba Murkomen and Hon. Sigei 🇰🇪 Empowering the Youth and Transforming Communities Crucially, the agreement extended beyond clerical matters into pressing social issues. It laid a foundation for national transformation through specific commitments to youth employment and empowerment, and the establishment of free rehabilitation centres in all sub-counties across Kenya. This demonstrated APECK\'s vision to partner with the government to address societal challenges head-on. The May 5th, 2022, signing marked a historic day where the Church, through APECK, secured a mandate not just to worship freely, but to actively participate in shaping a just, prosperous, and morally sound Kenya.', 'published', '2025-11-19 08:33:04', NULL, 'dab741fd-4162-456b-aa86-e510311ef18e', '2025-11-19 08:32:38', '2025-11-19 08:32:38', '/uploads/1763202273523-705231851.jpg', 1, 0, NULL),
	('5b812ec6-c23b-11f0-ba4f-00155dcfbcb2', 'building-a-better-future-with-our-spiritual-pillars', 'Building a Better Future with Our Spiritual Pillars', '​Fruitful consultations with the National Fathers and Archbishops of Kenya\'s churches. At deputy president official', '​Fruitful consultations with the National Fathers and Archbishops of Kenya\'s churches. At deputy president official residence alter. Rev. Ngugi APECK\'s National chairman together with Bishop J.B.Masinde,Arc Bishop urther Kitonga, Bishop Moffat Cleophas, Bishop Gachengo, Arc Bishop Kibarabara, Bishop Mungai, and the entire esteemed group, is committed to elevating the welfare and capacity of our clergy.​Excited to move forward on our plans for essential Mediation Training and ensuring a Dignified Living Standard through dedicated housing projects. The commitment to service is strong!\n\n​#NationalFathers #ChurchUnity #APE CKKenya #ClergyWelfare #KenyanBishops', 'published', '2025-11-19 16:24:38', NULL, 'dab741fd-4162-456b-aa86-e510311ef18e', '2025-11-15 15:54:24', '2025-11-15 15:54:24', '/uploads/1763202264546-175728204.jpg', 1, 0, '4'),
	('e94af037-6d97-4466-8388-15dd6c678c8a', 'a-prophetic-gathering', 'A Prophetic Gathering', 'The Church Endorses a President On July 16, 2022, Nyayo National Stadium was the epicentre of a monumental spiritual and political convergence as the Association of Pentecostal', 'The Church Endorses a President On July 16, 2022, Nyayo National Stadium was the epicentre of a monumental spiritual and political convergence as the Association of Pentecostal and Evangelical Clergy of Kenya (APECK) gathered over 5,000 clergy from all 47 counties for a National Prayer Summit. This event was far more than a routine religious assembly; it served as a powerful platform where the destiny of the nation was symbolically addressed through prayer and divine alignment. The immense turnout underscored the unified voice and significant influence of the Pentecostal and Evangelical movement on Kenya\'s political landscape, demonstrating their commitment to national transformation and leadership guided by faith. The summit reached its climax with a deeply symbolic and prophetic act: the anointing of the current President and his running mate. In the presence of thousands of spiritual leaders, the two were consecrated as "the Church Candidate," an unprecedented endorsement that publicly cemented a covenant between the religious movement and the political aspirant. This act was seen by many within the faith community as a spiritual commissioning, setting them apart and invoking divine favour for their bid for the nation\'s highest office, turning the event into a crucial hinge-point in the pre-election narrative. The prophetic declaration made at Nyayo Stadium materialised with remarkable speed. Barely a month after the sacred anointing, the candidate emerged victorious in the general election, fulfilling the church\'s prophetic mantle. His win marked a historic moment for Kenya, as he became the nation\'s first-ever Pentecostal President. This victory is viewed by many as a divine testament to the prayers and consecration offered at the Summit, permanently linking the APECK gathering on July 16th, 2022, to the establishment of the new presidency and the rise of a new political era rooted in the evangelical faith.', 'published', '2025-11-19 08:35:24', NULL, 'dab741fd-4162-456b-aa86-e510311ef18e', '2025-11-19 08:35:06', '2025-11-19 08:35:06', '/uploads/1763202239842-169679919.jpg', 1, 0, NULL);
...
-- Dumping data for table apeck.pages: ~12 rows (approximately)
...
INSERT INTO `page_sections` (`id`, `page_id`, `key`, `display_order`, `status`, `content`, `created_at`, `updated_at`) VALUES
	...
	('50c6804b-bf25-4e04-8720-e5d14ae6f4da', 'c0757362-c162-11f0-ba4f-00155dcfbcb2', 'about_mission_vision', 0, 'published', '{"visionIcon": "eye", "missionIcon": "target", "visionTitle": "Our Mission", "missionTitle": "Our Vision", "visionDescription": "To empower, equip, and unite Pentecostal and Evangelical clergy across Kenya through comprehensive training, spiritual development, and collaborative ministry initiatives.", "missionDescription": "A Kenya where every Pentecostal and Evangelical clergy member is fully equipped, spiritually vibrant, and effectively leading transformative ministries that impact communities for Christ."}', '2025-11-15 18:03:31', '2025-11-15 18:03:31'),
	...
	('8b569bda-6126-47a8-b536-c06a45960a09', '2cfde759-c162-11f0-ba4f-00155dcfbcb2', 'who_we_are', 0, 'published', '{"cta": {"href": "/about", "label": "Read Our Full Story"}, "image": "", "intro": "APECK is the premier association uniting Pentecostal and Evangelical clergy across Kenya. We are dedicated to empowering spiritual leaders through comprehensive training, mentorship, and resources that enable them to fulfill their calling with excellence.", "stats": [{"label": "Years Experience", "value": "15+"}, {"label": "Active Members", "value": "30,000+"}], "title": "Who We Are", "mission": "Our mission is to strengthen the body of Christ by equipping clergy with the tools, knowledge, and support they need to lead transformative ministries that impact communities and advance the Kingdom of God.", "imageAlt": "", "videoUrl": "https://www.youtube.com/watch?v=QUIepzddW8g", "badgeLabel": "WELCOME TO APECK1", "videoMedia": "", "videoPoster": "/uploads/1763202273523-705231851.jpg", "highlightWord": "APECK", "floatingBadgeTitle": "Since 2009", "floatingBadgeSubtitle": "Serving Kenya"}', '2025-11-15 10:57:52', '2025-11-15 10:57:52'),
...
-- Dumping data for table apeck.users: ~0 rows (approximately)
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `password_hash`, `role`, `is_active`, `last_login_at`, `reset_token`, `reset_token_expires_at`, `created_at`, `updated_at`) VALUES
	('dab741fd-4162-456b-aa86-e510311ef18e', 'Site', 'Admin', 'admin@apeck.org', '$2b$12$Kkj8sClCs4CDJbG5qFSIO.CaqSDBcbxkFO9zFxZKZkhekVssYtBZW', 'admin', 1, '2025-11-19 16:22:04', NULL, NULL, '2025-11-14 12:33:01', '2025-11-14 12:33:01');
...
-- Dumping data for table apeck.user_sessions: ~70 rows (approximately)
INSERT INTO `user_sessions` (`id`, `user_id`, `refresh_token_hash`, `user_agent`, `ip_address`, `expires_at`, `created_at`, `updated_at`) VALUES
	...
	('036e169b-6882-4e9f-8e89-9afdc4189ea0', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$HMl4DyF7fK/LDgJtyQWkNeNoDHJHqBVztPxjh48BPOJvkWtR4Nlwa', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 06:24:25', '2025-11-19 09:24:25', '2025-11-19 09:24:25'),
	('0512e8f3-e05b-4339-98ec-9759bbc081eb', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$CRCMpnlcoMhjBwaQ6JDCXuIH1WvPs5u39P3WEnmt4k0X13NPxdtSO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 09:24:12', '2025-11-19 12:24:12', '2025-11-19 12:24:12'),
	...
	('0a42d370-5faa-44e1-8f9f-e0b3076eca68', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$myZLqiOJGuyoaNDIeK5G2O0cb1hcwnHY8Irbvl107DGUSaHR2zXJS', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 11:33:11', '2025-11-19 14:33:11', '2025-11-19 14:33:11'),
	('0c00ba7f-3a77-473a-9dac-f06e787f8e7a', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$Xvn/Oydtlcet5mmpHEid5.xoCTrMmTDBUe6/VZ/1TWmbstvWeS3.q', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 09:23:39', '2025-11-19 12:23:39', '2025-11-19 12:23:39'),
	...
	('0d3b9e79-b88b-4f26-b08d-22bdb7601254', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$s/Z1RdO1rfTY/af6kOHnTe0QzDm9Czuw8Ga6uzKsUC4SuRjN2/FX.', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 03:10:28', '2025-11-19 06:10:28', '2025-11-19 06:10:28'),
	...
	('1937c9b1-528d-407f-bbc3-8db40a38e1c8', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$8pzkUhgRvLRE4ngHjxcMben/8WG3Ge6gnylnQ0vXHIx4rB9hXkAKq', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 11:03:37', '2025-11-19 14:03:37', '2025-11-19 14:03:37'),
	('1b6a6c15-4944-4331-9658-a37e0214b484', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$sepq.SylzASiZPVFz3mXT.K7R3YUxmqDj3C0BjVgSFC5Dhvbz7GoS', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 09:35:31', '2025-11-19 12:35:31', '2025-11-19 12:35:31'),
	('1b845955-9438-43d7-b0fe-9b571ee21d64', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$cK8afiq79sMWsqpY/.2E.OlfB/ZxafbgbigA4U..d789jI6WVWUeS', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-25 11:07:05', '2025-11-18 14:07:05', '2025-11-18 14:07:05'),
	...
	('2a136c08-ab60-4fb8-8f9d-f0a53cfaf51c', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$DTvA.khLSS/.5lZ2ARHhke38/i9uuvR8AopJaRtmaqusdH/V3QkC.', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 12:02:41', '2025-11-19 15:02:41', '2025-11-19 15:02:41'),
	...
	('2b9ee7d5-4767-4569-894b-c0a06c005373', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$X7vCYPKqPCWLUfACOqECnuwjK.CZc3BRiXDCkEzULNME6L59b46J.', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 08:41:10', '2025-11-19 11:41:10', '2025-11-19 11:41:10'),
	...
	('36f31f97-b7ad-460d-b37d-3069b08785c1', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$3BLfs.sNsMoo0s4df86xVuVG5WvIyUMYPzSvAQRE.eEZNUNYxAT6i', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 03:18:49', '2025-11-19 06:18:49', '2025-11-19 06:18:49'),
	...
	('43f5a744-3644-4817-9d71-09a42d56ad63', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$RHg0YgUjllT2vhup2kH7HOq2yehBy13WmQnwWCs/wPBYhM7qAhnei', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 03:11:47', '2025-11-19 06:11:47', '2025-11-19 06:11:47'),
	...
	('82143015-8d10-48cc-a0b3-e5f0d2d3ed88', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$FzY//KN2ogbrPZdEQyKvn.7CeauRNX6FBc1ipn2KiIswm.lHb7ORu', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 05:28:31', '2025-11-19 08:28:31', '2025-11-19 08:28:31'),
	...
	('d1c208af-ab04-4c65-963a-0fdd12f7ff0a', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$HiPzOp5DgA2pz6nYtWtNmO5kuQgmuGtHWSsR0cH29qQTb0QrLxNMC', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 03:30:59', '2025-11-19 06:30:59', '2025-11-19 06:30:59'),
	...
	('dd0f4bb2-ae80-4914-a780-ac15bb09364a', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$lbDKF8eHh4cpz/oAIFRoq.x.9eHi4S6Lr9D4qEHULCM.l2alFnrcu', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 11:18:12', '2025-11-19 14:18:12', '2025-11-19 14:18:12'),
	...
	('e8ee28e7-a251-4e8a-83df-5ffb34233d4d', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$gVM1SaDL/.mC1o9pwMpgTuOUhVpPuvTJEOnxRjS75pKCEGHRZP6Pa', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 03:10:58', '2025-11-19 06:10:58', '2025-11-19 06:10:58'),
	...
	('fb183fc9-3f42-47a4-bbaf-e1a394d2da0f', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$4CgK8G354KQ9oOoCUiZs7evetwxDHQPDNfCcW.cfGAmQ2pdjuMrjS', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 10:28:57', '2025-11-19 13:28:58', '2025-11-19 13:28:58'),
	...
	('fceec5d8-7621-4e74-8e34-af849aa17751', 'dab741fd-4162-456b-aa86-e510311ef18e', '$2b$12$971t5fWNfTM6Jh8MwXUYK.HrmOCF0scMbqD.P3Yx7IjioiGfbf8HG', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/142.0.0.0 Safari/537.36', '::1', '2025-11-26 13:22:04', '2025-11-19 16:22:05', '2025-11-19 16:22:05'),
