...
export function Contact() {
  ...
  return (
    <div className="relative w-full bg-gradient-to-b from-[#FBF7F2] via-[#F5F1EB] to-[#EFE7DE] dark:bg-gray-900 pt-20 overflow-hidden transition-colors duration-300">
      ...
      {/* Section Divider */}
      <div className="relative w-full overflow-hidden bg-gradient-to-b from-[#FDFBF7] via-white to-transparent dark:bg-gray-900">
      ...
      {/* Section Divider */}
      <div className="relative w-full overflow-hidden bg-gradient-to-b from-[#F6F2EA] via-[#F9F6F1] to-transparent dark:bg-gray-900">
        <div className="absolute top-0 left-0 w-full">
